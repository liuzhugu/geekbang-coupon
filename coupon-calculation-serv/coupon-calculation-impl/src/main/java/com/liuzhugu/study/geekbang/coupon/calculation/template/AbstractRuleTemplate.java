...
import com.liuzhugu.study.geekbang.coupon.calculation.api.beans.Product;
...
public abstract class AbstractRuleTemplate  implements RuleTemplate{
    ...
    public ShoppingCart calculate(ShoppingCart order) {
        ...
        //如果不符合优惠券使用标准  则直接按原价走  不适用优惠券
        if (shopTotalAmount == null || shopTotalAmount < threshold){
            log.warn("Totals of amout not meet,ur coupon are not applicable to this order");
    ...
    protected long covertToDecimal(Double value) {
